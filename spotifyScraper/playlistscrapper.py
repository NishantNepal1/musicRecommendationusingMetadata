...
def main():
    ...
    while not args.file:
        args.file = "{display_name}.csv".format(**me)
    ...
    que_test = input("Do you want to import a specific playlist? ")
    if que_test.upper() == "Y" :
        playlist_to_import = input("Write the name of the playlist ")
    ...
    with open(args.file, 'w', encoding='utf-8') as f:
        ...
        # Comma-separated file.
            ...
            for playlist in playlists:
                ...
                if que_test.upper() == "Y":
                    playlist_name = "{name}".format(**playlist)
                    if playlist_name.upper() == playlist_to_import.upper():
